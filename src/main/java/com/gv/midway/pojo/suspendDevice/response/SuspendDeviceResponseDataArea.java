...
public class SuspendDeviceResponseDataArea {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SuspendDeviceResponseDataArea other = (SuspendDeviceResponseDataArea) obj;
		if (orderNumber == null) {
	...
	public String toString() {
		return "SuspendDeviceResponseDataArea [orderNumber=" + orderNumber
				+ "]";
	}
}
