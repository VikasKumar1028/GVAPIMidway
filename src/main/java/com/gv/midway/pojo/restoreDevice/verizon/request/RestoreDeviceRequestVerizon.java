package com.gv.midway.pojo.restoreDevice.verizon.request;
...
public class RestoreDeviceRequestVerizon {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RestoreDeviceRequestVerizon other = (RestoreDeviceRequestVerizon) obj;
        if (accountName == null) {
    ...
    public String toString() {
        return "RestoreDeviceRequestVerizon [groupName=" + groupName
