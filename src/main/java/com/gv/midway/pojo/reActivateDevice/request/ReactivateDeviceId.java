...
public class ReactivateDeviceId {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ReactivateDeviceId)) {
			return false;
		}
		ReactivateDeviceId other = (ReactivateDeviceId) obj;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
	...
	public String toString() {
		return "ReactivateDeviceId [id=" + id + ", kind=" + kind + "]";
	}
