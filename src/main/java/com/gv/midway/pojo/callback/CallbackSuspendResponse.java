...
public class CallbackSuspendResponse {
    ...
    public void setNumDaysSuspendAllowedCurrent12Months(
            String numDaysSuspendAllowedCurrent12Months) {
    ...
    public void setNumDaysSuspendedLast12Months(
            String numDaysSuspendedLast12Months) {
        this.numDaysSuspendedLast12Months = numDaysSuspendedLast12Months;
    }

    @Override
    public String toString() {
        return "ClassPojo [maxSuspendDaysAllowed = " + maxSuspendDaysAllowed
                + ", expectedResumeDate = " + expectedResumeDate
                + ", numDaysSuspendAllowedCurrent12Months = "
                + numDaysSuspendAllowedCurrent12Months
                + ", numDaysSuspendedLast12Months = "
                + numDaysSuspendedLast12Months + "]";
    }
