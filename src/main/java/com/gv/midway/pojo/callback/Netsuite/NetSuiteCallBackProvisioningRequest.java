...
public class NetSuiteCallBackProvisioningRequest {
     ...
     * result = prime result + ((carrierOrderNumber == null) ? 0 :
     * carrierOrderNumber .hashCode()); result = prime * result +
     * Arrays.hashCode(deviceIds); result = prime * result + ((netSuiteID ==
     * null) ? 0 : netSuiteID.hashCode()); result = prime * result +
     * ((requestType == null) ? 0 : requestType.hashCode()); result = prime *
     * result + ((response == null) ? 0 : response.hashCode()); result = prime *
     * result + ((status == null) ? 0 : status.hashCode()); return result; }
     * 
     * @Override public boolean equals(Object obj) { if (this == obj) return
     * true; if (obj == null) return false; if (getClass() != obj.getClass())
     * return false; NetSuiteCallBackProvisioningRequest other =
     * (NetSuiteCallBackProvisioningRequest) obj; if (carrierOrderNumber ==
     * null) { if (other.carrierOrderNumber != null) return false; } else if
     * (!carrierOrderNumber.equals(other.carrierOrderNumber)) return false; if
     * (!Arrays.equals(deviceIds, other.deviceIds)) return false; if (netSuiteID
     * == null) { if (other.netSuiteID != null) return false; } else if
     * (!netSuiteID.equals(other.netSuiteID)) return false; if (requestType !=
     * other.requestType) return false; if (response == null) { if
     * (other.response != null) return false; } else if
     * (!response.equals(other.response)) return false; if (status == null) { if
     * (other.status != null) return false; } else if
     * (!status.equals(other.status)) return false; return true; }
     * 
     ...
     * builder.append(Arrays.toString(deviceIds));
     * builder.append(", carrierOrderNumber=");
     * builder.append(carrierOrderNumber); builder.append(", requestType=");
     * builder.append(requestType); builder.append(", netSuiteID=");
     * builder.append(netSuiteID); builder.append(", status=");
     * builder.append(status); builder.append(", response=");
     * builder.append(response); builder.append("]"); return builder.toString();
     * }
     */
