...
public class ChangeDeviceServicePlanValidatorProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		if (changeDeviceServicePlansRequestDataArea == null) {
			...
			final String currentServicePlan = changeDeviceServicePlansRequestDataArea.getCurrentServicePlan();
			final String servicePlan = changeDeviceServicePlansRequestDataArea.getServicePlan();
	...
	private void missingServicePlan(Exchange exchange) throws MissingParameterException {
		...
		exchange.setProperty(IConstant.RESPONSE_STATUS, IResponse.ERROR_DESCRIPTION_CHANGE_SERVICE_PLAN);
