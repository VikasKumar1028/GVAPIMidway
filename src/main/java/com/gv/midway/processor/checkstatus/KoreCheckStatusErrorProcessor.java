...
public class KoreCheckStatusErrorProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        LOGGER.debug("Begin:KoreCheckStatusErrorProcessor");
        ...
        if (exception != null) {
            LOGGER.error("cxf exception while checking the status of Kore Provisioning request");
        ...
        LOGGER.error("error callback response for Kore..." + exchange.getIn().getBody());
        LOGGER.debug("End:KoreCheckStatusErrorProcessor");
    }
}