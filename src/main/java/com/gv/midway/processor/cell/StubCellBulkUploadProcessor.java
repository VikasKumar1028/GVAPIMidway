...
public class StubCellBulkUploadProcessor implements Processor {
	...
	Logger log = Logger.getLogger(StubCellBulkUploadProcessor.class
			.getName());

	public void process(Exchange exchange) throws Exception {

		log.info("StubCellBulkUploadProcessor");
		System.out.println("StubCellBulkUploadProcessor Called......................");
		...
		DeviceInformation[] DeviceInformationArray = { deviceInformation1, deviceInformation2};
		...
		deviceInformation1.setNetSuiteId("NS001");
		cell.setEsn("ESN001");
		cell.setMdn("MDN001");
		cell.setSim("SIM001");
		...
		deviceInformation2.setNetSuiteId("NS001");
		cell.setEsn("ESN001");
		cell.setMdn("MDN001");
		cell.setSim("SIM001");
		...
		extendedAttributes1[1] = new ExtendedAttributes("key2", "CostCenterCode");
	...
	System.out.println("Exchange Result is..........." +(batchDeviceResponse));
	}
