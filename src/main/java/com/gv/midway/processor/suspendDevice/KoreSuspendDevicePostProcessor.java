...
public class KoreSuspendDevicePostProcessor implements Processor {
	...
	Logger log = Logger.getLogger(KoreSuspendDevicePostProcessor.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		...
		log.info("Start::KoreSuspendDevicePostProcessor");
		...
		SuspendDeviceResponseDataArea.setOrderNumber(exchange.getProperty(IConstant.MIDWAY_TRANSACTION_ID).toString());
