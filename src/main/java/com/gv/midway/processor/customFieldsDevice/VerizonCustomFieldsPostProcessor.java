...
public class VerizonCustomFieldsPostProcessor implements Processor {
    ...
    private static final Logger LOGGER = Logger.getLogger(VerizonCustomFieldsPostProcessor.class
            .getName());
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        LOGGER.info("Begin::VerizonCustomFieldsPostProcessor");
        ...
        LOGGER.info("End::VerizonCustomFieldsPostProcessor");
    }
