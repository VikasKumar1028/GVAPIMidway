...
public class ATTJasperBatchExceptionProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		LOGGER.debug("Begin:ATTJasperBatchExceptionProcessor");
		...
		if (ex.getCause() instanceof UnknownHostException
			...
			LOGGER.debug("reason of connection error is......."	+ CommonUtil.getStackTrace(ex));
		...
		LOGGER.debug("End:ATTJasperBatchExceptionProcessor");
	}
}
