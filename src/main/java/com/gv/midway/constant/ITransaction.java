...
public class ITransaction {
	...
	public static final String AUDIT_TRANSATION_ID = "auditTransationID";
	public static final String CALL_BACK_RECEIVED = "callBackReceived";
	public static final String CALL_BACK_FAILURE_TO_NETSUIT_REASON = "callBackFailureToNetSuitReason";
