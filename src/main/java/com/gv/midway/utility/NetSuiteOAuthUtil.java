...
public class NetSuiteOAuthUtil {
	...
	private static Logger log = Logger.getLogger(NetSuiteOAuthUtil.class);
	...
	public static String getNetSuiteOAuthHeader(String url, String consumerKey,
		...
		log.info("signature base String is.........." + signatureString);

		String oauth_signature = generateSignature(signatureString,
				consumerSecret, tokenSecret);

		log.info("oauth signatue.........." + oauth_signature);

		String encodedAuthString = URLEncoder.encode(oauth_signature, "UTF-8");

		log.info("encoded oauth String is......." + encodedAuthString);
		...
		log.info("Oauth 1.0 netSuite Header is......." + basicAuth);
