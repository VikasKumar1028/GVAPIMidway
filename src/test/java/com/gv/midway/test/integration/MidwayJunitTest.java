...
public class MidwayJunitTest extends Assert {
	...
	private static final Logger LOGGER = Logger.getLogger(MidwayJunitTest.class
			.getName());
	...
	// 20.Test Activate device API for ATT JASPER with correct data.
	@Test
	public void testActivateDeviceRequestATTJasperWithValidData()
			throws Exception {
	...
	// 21. Test Activate Device API for ATT Jasper with invalid data.By Passing
	// wrong Id value and blank kind value for device Id.
	@Test
	public void testActivateDeviceRequestATTJasperWithInvalidData()
			throws Exception {
		...
		header.setRegion("USA");
		header.setTimestamp("timestamp");
		header.setTransactionId("2016-06-30T09:09:52-04:00");
	...
	// 22.Test Case for Deactivate Device for ATTJasper with Correct data
	@Test
	public void testDeactivateDeviceRequestATTJasperWithValidData()
			throws Exception {
		...
		deactivateDeviceId1.setId("89011702272013902603");
		deactivateDeviceId1.setKind("ICCID");

		DeActivateDeviceIdArray[0] = deactivateDeviceId1;

		deactivateDeviceId2.setId("89011702272013902595");
		deactivateDeviceId2.setKind("ICCID");
	...
	// 23.test case for Reactivate Device for ATTJASPER with Correct data
	@Test
	public void testReactivateDeviceRequestATTJasperWithValidData()
			throws Exception {
	...
	@Test
	public void testRestoreDeviceRequestATTJasperWithValidData()
			throws Exception {
	...
	// 25. Test Case for Suspended Device ATTJasper with valid data
	@Test
	public void testSuspendDeviceRequestATTJasperWithValidData()
			throws Exception {
	...
	// 27 test case for change Device Service Plan for ATTJasper with valid data
	@Test
	public void testChangeDeviceServicePlanRequestATTJasperWithValidData()
			throws Exception {
		...
		dataArea.setServicePlan("Developer Kit Plan - Monthly Plan");
		dataArea.setCurrentServicePlan("M2M5MBASH");
